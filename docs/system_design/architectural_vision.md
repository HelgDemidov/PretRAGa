...
[сквозной словарь сущностей](entity_map/entity_glossary.md); терминология — только оттуда.
...
Определения — в [словаре сущностей](entity_map/entity_glossary.md). Каркас связей:
